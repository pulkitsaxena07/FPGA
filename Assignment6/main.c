...
int main(void)
{
    ...
    //input pins
    PyHal_GPIO_SetDir(1,0);  // x
    PyHal_GPIO_SetDir(5,0);  // y
    PyHal_GPIO_SetDir(11,0);  // z
    //PyHal_GPIO_SetDir(15,0);  // w
    	
    //int x, y, z, w, out;
    int a,b,c,out;	
    while(1)
    {
        a = PyHal_GPIO_Get(1); //taking input x
        b = PyHal_GPIO_Get(5);	//taking input y
        c = PyHal_GPIO_Get(11);	//taking input z
       // w = PyHal_GPIO_Get(15);	//taking input w
